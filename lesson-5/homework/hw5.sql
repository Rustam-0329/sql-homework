...
SELECT DISTINCT CONCAT(FirstName, ' ', LastName) AS FullName, Country
FROM Customers
...
SELECT CONCAT(FirstName, ' ', LastName) AS FullName, Age, Salary
FROM Employees
...
SELECT *,
		CASE WHEN SaleAmount IS NULL THEN 'Unknown'
